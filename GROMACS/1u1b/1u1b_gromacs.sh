...
gmx pdb2gmx -f 1U1B_original.pdb \
		-o 1U1B_forcefield.gro \
		-water tip3p \
		-ff charmm27 \
		-ignh
...
gmx editconf -f 1U1B_forcefield.gro -o 1U1B_box.gro -c -d 1.0 -bt cubic

# Solvating box created previously.
gmx solvate -cp 1U1B_box.gro -cs spc216.gro -o 1U1B_solvated.gro -p topol.top
...
gmx grompp -f minim.mdp -c 1U1B_ions.gro -p topol.top -o em.tpr
